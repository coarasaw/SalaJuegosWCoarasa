...
export class PreguntadosComponent implements OnInit {
  ...
  imgPokemon: any;
<<<<<<< HEAD
  charizard: any; // ¿Cuál es la habilidad de Charizard?
  poliwag: any; //¿Cómo se llama este Pokemon?
  mew: any; //¿Cuál es la habilidad de Mew?
  gastly: any; // ¿Cuál es la evolucion de Gastly?
  pikachu: any; //¿Cuál es la evolucion de Pikachu?
  bulbasaur: any; // ¿Que habilidad tiene bulbasaur?
=======
...
<<<<<<< HEAD
  pregunta_01: string[] = ['1', '¿Cuál es la habilidad de Charizard?', 'Correr', 'Salto de rana', 'Blaze', 'Vuela alto', '4'];
  pregunta_02: string[] = ['2', '¿Cómo se llama este Pokemon?', 'Gofy', 'Poliwag', 'Blastoise', 'Caterpie', '3'];
  pregunta_03: string[] = ['3', '¿Cuál es la habilidad de Mew?', 'Pisar fuerte', 'Rayos', 'Magia', 'Sincronia', '5'];
  pregunta_04: string[] = ['4', '¿Cuál es la evolucion de Gastly?', 'En Atun', 'A Vaca voladora', 'A Topo', 'A Genar', '5'];
  pregunta_05: string[] = ['5', '¿Cuál es la evolucion de Pikachu?', 'Charizard', 'Miki','Mew', 'Pichu', '5'];
  pregunta_06: string[] = ['6', '¿Qué habilidad tiene bulbasaur?', 'Rebota mucho', 'Espesura', 'Elastico', 'Gases fuertes', '3'];
=======
